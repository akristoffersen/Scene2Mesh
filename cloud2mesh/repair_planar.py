"""
This is a tutorial from: https://pymeshfix.pyvista.org/api.html
...
output_path="mesh/"
dataname="bpa_mesh_6_lapl.obj"#"sample_w_normals.xyz"
###############################################################################
# plot the holes on the original mesh
orig_mesh = pv.read(output_path+dataname) #input_path+dataname
# orig_mesh = pv.read(planar_mesh) #input_path+dataname
print(orig_mesh)
...
mfix.load_file(output_path+dataname)
